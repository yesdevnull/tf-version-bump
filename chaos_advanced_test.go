...
func TestHugeVersionString(t *testing.T) {
  ...
  version = "1.0.0"
	...
	updated, err := updateModuleVersion(testFile, "terraform-aws-modules/vpc/aws", hugeVersion, nil, nil, nil, false, false, false)
	if err != nil {
		t.Fatalf("Failed to process: %v", err)
	}
...
func TestConfigWithDuplicateSources(t *testing.T) {
  ...
  - source: "terraform-aws-modules/s3-bucket/aws"
	...
	for _, update := range updates {
		updated, err := updateModuleVersion(testFile, update.Source, update.Version, update.From, update.IgnoreVersions, update.Ignore, false, false, false)
		if err != nil {
...
func TestSourceWithEscapedCharacters(t *testing.T) {
  ...
  version = "3.0.0"
	...
	updated, err := updateModuleVersion(testFile, source, "5.0.0", nil, nil, nil, false, false, false)
	if err != nil {
		t.Fatalf("Failed to process: %v", err)
	}
...
func TestVeryLongModuleSource(t *testing.T) {
  ...
  version = "3.0.0"
	...
	updated, err := updateModuleVersion(testFile, longSource, "5.0.0", nil, nil, nil, false, false, false)
	if err != nil {
...
func TestFromVersionNotMatching(t *testing.T) {
  ...
  version = "3.0.0"
	...
	updated, err := updateModuleVersion(testFile, "terraform-aws-modules/vpc/aws", "5.0.0", []string{"99.99.99"}, nil, nil, false, false, false)
	if err != nil {
		t.Fatalf("Failed to process: %v", err)
	}
...
func TestDryRunModificationTime(t *testing.T) {
  ...
  version = "3.0.0"
	...
	// Run in dry-run mode
	_, err = updateModuleVersion(testFile, "terraform-aws-modules/vpc/aws", "5.0.0", nil, nil, nil, false, true, false)
	if err != nil {
