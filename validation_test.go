...
func TestFileSystemEdgeCases(t *testing.T) {
	t.Run("directory instead of file", func(t *testing.T) {
		...
		_, err := updateModuleVersion(tmpDir, "test", "1.0.0", nil, nil, nil, false, false, false, "text")
...
func TestConcurrentSafetyConsiderations(t *testing.T) {
  ...
  version = "1.0.0"
		...
		for i := 2; i <= 5; i++ {
			...
			_, err := updateModuleVersion(testFile, "terraform-aws-modules/vpc/aws", version, nil, nil, nil, false, false, false, "text")
			if err != nil {
...
func TestErrorMessageQuality(t *testing.T) {
	t.Run("file not found error includes path", func(t *testing.T) {
		...
		_, err := updateModuleVersion(nonExistent, "test", "1.0.0", nil, nil, nil, false, false, false, "text")
