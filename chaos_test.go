...
func TestNullBytesInFile(t *testing.T) {
	...
	_, err = updateModuleVersion(testFile, "terraform-aws-modules/vpc/aws", "5.0.0", nil, nil, false, false, false)
...
func TestSymbolicLinks(t *testing.T) {
  ...
  version = "3.0.0"
	...
	// Update via symlink
	updated, err := updateModuleVersion(linkFile, "terraform-aws-modules/vpc/aws", "5.0.0", nil, nil, false, false, false)
	if err != nil {
...
func TestExtremelyNestedModuleSource(t *testing.T) {
  ...
  version = "3.0.0"
	...
	updated, err := updateModuleVersion(testFile, deepSource, "5.0.0", nil, nil, false, false, false)
	if err != nil {
...
func TestModuleSourceWithQueryParams(t *testing.T) {
  ...
  version = "3.0.0"
			...
			updated, err := updateModuleVersion(testFile, tt.source, "5.0.0", nil, nil, false, false, false)
			if err != nil {
...
func TestInvalidVersionFormats(t *testing.T) {
  ...
  version = "3.0.0"
			...
			updated, err := updateModuleVersion(testFile, "terraform-aws-modules/vpc/aws", tt.version, nil, nil, false, false, false)
...
/* Multi-line
   comment */`
	...
	updated, err := updateModuleVersion(testFile, "test", "1.0.0", nil, nil, false, false, false)
	if err != nil {
...
func TestFromVersionWithSpecialChars(t *testing.T) {
  ...
  version = "3.0.0-rc.1+build.123"
	...
	updated, err := updateModuleVersion(testFile, "terraform-aws-modules/vpc/aws", "5.0.0", []string{"3.0.0-rc.1+build.123"}, nil, false, false, false)
	if err != nil {
