...
report_file="examples/github-actions/.github/workflows/tf-version-bump-report.yml"
...
files=("$production_file" "$nonproduction_file" "$report_file" "$config_validation_file" "$test_file" "$readme_file" "$guide_file")
...
pin_markers=(
    ...
    "      tf_version_bump_version:" "      tf_version_bump_archive_sha256:"
    "          REPORT_TF_VERSION_BUMP_VERSION:" "          REPORT_TF_VERSION_BUMP_ARCHIVE_SHA256:"
    "" "" "" "" ""
...
current_values=(
    ...
    "tf_version_bump_version: $current_version" "tf_version_bump_archive_sha256: $current_digest"
    "REPORT_TF_VERSION_BUMP_VERSION: $current_version" "REPORT_TF_VERSION_BUMP_ARCHIVE_SHA256: $current_digest"
...
new_values=(
    ...
    "tf_version_bump_version: $version" "tf_version_bump_archive_sha256: $digest"
    "REPORT_TF_VERSION_BUMP_VERSION: $version" "REPORT_TF_VERSION_BUMP_ARCHIVE_SHA256: $digest"
