...
func TestHugeVersionString(t *testing.T) {
  ...
  version = "1.0.0"
	...
	updated, err := updateModuleVersion(testFile, "terraform-aws-modules/vpc/aws", hugeVersion, nil, nil, nil, false, false, false, "text")
	if err != nil {
		t.Fatalf("Failed to process: %v", err)
	}
...
func TestSourceWithEscapedCharacters(t *testing.T) {
  ...
  version = "3.0.0"
	...
	updated, err := updateModuleVersion(testFile, source, "5.0.0", nil, nil, nil, false, false, false, "text")
	if err != nil {
		t.Fatalf("Failed to process: %v", err)
	}
...
func TestVeryLongModuleSource(t *testing.T) {
  ...
  version = "3.0.0"
	...
	updated, err := updateModuleVersion(testFile, longSource, "5.0.0", nil, nil, nil, false, false, false, "text")
	if err != nil {
...
func TestFromVersionNotMatching(t *testing.T) {
  ...
  version = "3.0.0"
	...
	updated, err := updateModuleVersion(testFile, "terraform-aws-modules/vpc/aws", "5.0.0", []string{"99.99.99"}, nil, nil, false, false, false, "text")
	if err != nil {
		t.Fatalf("Failed to process: %v", err)
	}
...
func TestDryRunModificationTime(t *testing.T) {
  ...
  version = "3.0.0"
	...
	// Run in dry-run mode
	_, err = updateModuleVersion(testFile, "terraform-aws-modules/vpc/aws", "5.0.0", nil, nil, nil, false, true, false, "text")
	if err != nil {
